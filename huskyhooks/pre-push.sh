#!/bin/sh
​
FORBIDDEN_HTTPS_URL="https://github.com/jonsoku2/tamastudy.git" # insert your remote url (https)
FORBIDDEN_SSH_URL="git@github.com:jonsoku2/tamastudy.git" # insert your remote url (ssh)
