...
import {
  CREATE_CATEGORY_FAIL, CREATE_CATEGORY_REQUEST, CREATE_CATEGORY_SUCCESS,
  DELETE_CATEGORY_FAIL,
  DELETE_CATEGORY_REQUEST,
  DELETE_CATEGORY_SUCCESS,
  GET_CATEGORY_LIST_FAIL, GET_CATEGORY_LIST_REQUEST,
...
const reducer = (state = initialState, action) => produce(state, (draft) => {
  switch (action.type) {
    ...
    case DELETE_CATEGORY_SUCCESS: {
      ...
      draft.deleteCategoryError = null;
      draft.categoryList = draft.categoryList.filter((catrgory) => catrgory.id !== action.payload);
      break;
    }
